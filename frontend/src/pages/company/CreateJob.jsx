...
function CreateJob() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (cleanData.salary_min) cleanData.salary_min = parseGermanNumber(cleanData.salary_min);
      if (cleanData.salary_max) cleanData.salary_max = parseGermanNumber(cleanData.salary_max);
