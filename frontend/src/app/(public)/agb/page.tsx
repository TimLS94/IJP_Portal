...
export const metadata: Metadata = {
  ...
  description: "Allgemeine Geschäftsbedingungen der IJP International Job Placement UG - Nutzungsbedingungen, Haftung und rechtliche Bestimmungen.",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8">
            ...
            {/* Registrierung */}
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 3 Registrierung</h2>
              <div className="text-gray-700 space-y-3">
                <p>
            ...
            {/* Datenschutz */}
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 5 Datenschutz</h2>
              <div className="text-gray-700 space-y-3">
                <p>
            ...
            {/* Kündigung */}
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 7 Kündigung</h2>
              <div className="text-gray-700 space-y-3">
                <p>
