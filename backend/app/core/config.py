...
class Settings(BaseSettings):
    ...
    # Neue Domain jobonportal.de; alte jobon.work bleibt übergangsweise erlaubt (Migration)
    CORS_ORIGINS: str = "http://localhost:5173,http://localhost:3000,https://www.jobonportal.de,https://jobonportal.de,https://www.jobon.work,https://jobon.work"
