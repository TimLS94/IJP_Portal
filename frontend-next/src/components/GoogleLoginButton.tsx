...
export default function GoogleLoginButton({ buttonText = "Mit Google fortfahren", onSuccess }: GoogleLoginButtonProps) {
    ...
    <div className="w-full">
      {processing ? (
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
